# Trace 时迹 — 逐页 UI/UX 设计规范 v1.0

> **文档目的**：本文档是 Trace 时迹每一页的像素级 UI/UX 设计规范。任何开发者（包括 AI Agent）阅读本文档后，应能精确还原每一个页面的布局、间距、颜色、字体、交互状态。本文档基于 Dual Layer Macaron 设计系统和产品蓝图 v3.0。
>
> **最后更新**：2026-04-21
>
> **设计系统版本**：Dual Layer Macaron v3
>
> **参考文档**：`docs/DESIGN_SYSTEM.md`, `docs/EXECUTION_GUARDIAN_BLUEPRINT.md`
...
| **Active (selected)** | `#FEE2E2` (coral soft bg) | `2px solid var(--color-border-strong)` #D6D3CD | `4px 4px 0px var(--color-border-strong)` | `var(--color-text-primary)` #3A3638 | `#FF8C82` |
